...
% FUT7.targetbranchcontain = glycanMLread('518.26fut4.glycoct_xml');
...
% FUT9.targetbranchcontain = glycanMLread('518.26fut4.glycoct_xml');
...
%glycanMLread('763.38.glycoct_xml')
...
glycanViewer(a2.glycanStruct,displayOptions);
% glycanViewer(a3.glycanStruct,displayOptions);
[isPath,olinkedpath]=inferGlyConnPath(glycanArray,enzArray,'iterativedisp',true);
