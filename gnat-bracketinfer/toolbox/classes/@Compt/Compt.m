...
%  reactortype        - the reactor type
%  spatialdimensions  - the spatial dimensions for the volume
%  priorcompt         - the reference to the prior compartment
%  posteriorcompt     - the reference to the posterior compartment
%
% Compt methods:
