...
a1   = GlycanSpecies(glycanMLread('TEST1.glycoct_xml'));%Tetra_antennary_2Lac_3NeuAc_bracket;Bi_antennary_2NeuAc_a1_3Fuc_bisecting_bracket_NAfut
% a2   = GlycanSpecies(glycanMLread('Tetra_antennary_2Lac_3NeuAc_bracket.glycoct_xml'));% Bi_antennary_structure_NeuAc_bracket,Bi_antennary_2GlcNAc
a3   = GlycanSpecies(glycanMLread('M3gn.glycoct_xml'));
...
[isPath,nlinkedpath]=inferGlyConnPath_bracket(glycanArray,enzArray);
